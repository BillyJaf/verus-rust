...
struct_with_invariants!{
    pub struct Global {
        ...
        pub atomic: AtomicU32<_, machine::counter, _>,
    ...
    spec fn wf(&self) -> bool {
        // Specify the invariant that should hold on the AtomicU32<machine::counter>.
        ...
        invariant on atomic with (instance) is (v: u32, g: machine::counter) {
...
fn main() {
    ...
    let tr_instance: Tracked<machine::Instance> = Tracked(instance.clone());
