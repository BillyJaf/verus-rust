...
pub fn print_pop(peaw: PoppedElemAndWitness) {
    match peaw.elem {
...
#[verifier::external_body]
pub fn print_header(header: &str, description: &str) {
    println!("======= {} =======", header);
    println!("{}", description);
    println!("");
}
...
pub fn main() {
    ...
    print_header("SINGLE THREADED TEST", "Expect 1, 2, 3 - in that order.");
    ...
    print_header("COMPLETE MULTI THREADED TEST", "Expect 0, 1, ..., 9 - in any order.");
    ...
    print_header("INCOMPLETE MULTI THREADED TEST", "Expect a subset of 0, 1, ..., 9 - in any order, some None.");
