...
verus!{
    ...
    pub fn swap_two_elements_ref(array: &mut Vec<i32>, index_1: usize, index_2: usize)
        requires
    ...
    pub fn swap_two_elements(array: Vec<i32>, index_1: usize, index_2: usize) -> (swapped_array: Vec<i32>)
        requires
            index_1 < array.len(),
            index_2 < array.len(),
        ensures
